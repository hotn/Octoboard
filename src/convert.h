...
class Convert {
    public:
         ...
         */
        static int ColorToAnalog(const RgbColor color);
         ...
         * to the end color.
         */
        static int* ColorRangeToAnalogs(const RgbColor startColor, const RgbColor endColor, int stepCount);
         ...
         */
        static RgbColor* ColorRangeToColors(const RgbColor startColor, const RgbColor endColor, int stepCount);
         ...
         */
        static RgbColor ColorToBrightnessAdjustedColor(const RgbColor color, int analogValue, int minimumBrightness = 0, int maximumBrightness = 100);
